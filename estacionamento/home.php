...
$query =$pdo->query("SELECT e.id, e.data, e.hora, e.status, c.nome, c.contato, v.tipo, v.placa, v.modelo, u.nome as operador FROM tbl_estacionamento as e 
INNER JOIN tbl_usuario as u ON e.operador_id = u.id 
INNER JOIN tbl_cliente as c ON e.cliente_id = c.id 
INNER JOIN tbl_veiculo as v ON v.cliente_id = c.id
    ...
    <div id="grid-container">
        ...
        <div >
            ...
            <div id="link">
                ...
                <div class="button-link"> <a  href="usuario.php"> Perfil do operador </a> </div>
                <div class="button-link"> <a  href="registrar.php"> Cadastro de veículo </a> </div>
                ...
                <table>
                    ...
                    <?php foreach($query as $resultado): ?>
                        <tr>
                            ...
                            <td class="button-table"> <a href="detalhes.php?id=<?php echo $resultado['id']; ?>" > Mais detalhes </a> </td>
